...
class PatchGAN(nn.Module):
    ...
    def __init__(self, num_classes, ndf=64, n_layers=3, norm_layer=nn.BatchNorm2d):
        """Construct a PatchGAN discriminator
        Parameters:
            num_classes (int)  -- the number of channels in input images
        ...
        kw = 4
        padw = 1
        sequence = [nn.Conv2d(num_classes, ndf, kernel_size=kw, stride=2, padding=padw), nn.LeakyReLU(0.2, True)]
        nf_mult = 1
        nf_mult_prev = 1
