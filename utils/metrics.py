...
def evaluate_segmentation(pred, label, num_classes, score_averaging="weighted"):
    ...
    iou, iou_list = compute_mean_iou(flat_pred, flat_label)

    return global_accuracy, class_accuracies, prec, rec, f1, iou, iou_list
...
class Performance_Metrics(object):
    ...
    def __init__(self, ga, ca, prec, recall, f1, iou, iou_list, iou_all):
        self.GA = ga
        self.CA = ca
        self.Precision = prec
        self.Recall = recall
