...
from utils.trainer import run_training_single_D
...
def main(args):
    ...
    args.iter_semi_start = args.epoch_semi_start * source_data.__len__() // args.batch_size
    ...
    val_loss, val_miou = run_training_single_D(
